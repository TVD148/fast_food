        ...
        <div className="row align-items-center">
          ...
          <div className="col-md-6 pe-md-5">
            ...
            <div className="d-flex align-items-center gap-3">
              ...
              <span className="text-secondary fw-bold">04</span>
              <button className="btn btn-outline-secondary rounded-circle p-2 ms-2"><i className="bi bi-arrow-left"></i></button>
              <button className="btn btn-warning rounded-circle p-2"><i className="bi bi-arrow-right"></i></button>
            </div>
          </div>
          ...
          <div className="col-md-6 text-center position-relative mt-5 mt-md-0">
             ...
             <img 
               ...
               style={{maxWidth: '100%', filter: 'drop-shadow(0px 20px 30px rgba(0,0,0,0.5))'}} 
             />
          </div>
